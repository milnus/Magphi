...
Magphi -g evidence_levels_simple_two_contigs_cross_conenct.fasta -s two_primers_simple_match_primers.fasta -o test_out_folder -md 180
...
test_output_file test_out_folder/two_primers_simple/evidence_levels_simple_two_contigs-two_primers_simple.fasta evidence_level_multi_seed_hit_cross_contig_connect/evidence_levels_simple_two_contigs-two_primers_simple.fasta
rm -r test_out_folder
