...
Magphi -g \
larger_Magphi_test/ERR033882.gff \
larger_Magphi_test/ERR111968.gff \
larger_Magphi_test/ERR449328.gff \
larger_Magphi_test/ERR1734483.gff \
-s larger_test_primers.fa -o test_out_folder -md 15000 -is
