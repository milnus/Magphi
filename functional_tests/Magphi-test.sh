...
test_output_file test_out_folder/annotation_primers/evidence_levels_single_contig-two_primers_simple.fasta evidence_level_single_contigs_connect_annotations_include_seeds/evidence_levels_single_contig-annotation_primers.gff
test_output_file test_out_folder/annotation_primers/evidence_levels_single_contig-two_primers_simple.fasta evidence_level_single_contigs_connect_annotations_include_seeds/evidence_levels_single_contig-annotation_primers.fasta
