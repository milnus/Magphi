...
test_exit_status "$test_program -g test_fasta.fna test_GFF.gff -S -s empty_file > /dev/null 2>&1" 3
...
test_exit_status "$test_program -g test_fasta.fna random_text.txt -S -s empty_file > /dev/null 2>&1" 3
...
test_exit_status "$test_program -g test_GFF.gff random_text.txt -S -s empty_file > /dev/null 2>&1" 3
# Test when just random text file is given as input
call_new_test "Test when just random text file is given as input"
test_exit_status "$test_program -g random_text.txt -S -s empty_file > /dev/null 2>&1" 3
# Test when empty file is given as input
call_new_test "Test when empty file is given as input"
test_exit_status "$test_program -g empty_file -S -s empty_file > /dev/null 2>&1" 3
...
test_output_file test_out_folder/fixstart/Fix_start_genome-fixstart.gff fix_start/Fix_start_genome_2-fixstart_reverse_complement.gff.expected
rm -r test_out_folder
