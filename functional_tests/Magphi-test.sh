...
test_output_file test_out_folder/two_primers_simple/two_contigs_two_primers_single_hit-annotation_primers_1_break.fasta evidence_levels_simple_hits_cross_contig_connected/two_contigs_two_primers_single_hit-annotation_primers_1_break.fasta
test_output_file test_out_folder/two_primers_simple/two_contigs_two_primers_single_hit-annotation_primers_2_break.fasta evidence_levels_simple_hits_cross_contig_connected/two_contigs_two_primers_single_hit-annotation_primers_2_break.fasta
